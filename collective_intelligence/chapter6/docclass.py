...
class classifier:
    ...
    def incf(self,f,cat):
        ...
        if count==0:
            ...
            self.con.execute("update fc set count=%d where feature='%s' and category='%s'" % (count,f,cat))
    ...
    def incc(self,cat):
        ...
        if count==0:
            ...
            self.con.execute("update cc set count=%d where category='%s'" % (count+2,cat))
    ...
    def fprob(self,f,cat):
        ...
        # category divided by the toal number of items in this category
    ...
    def weightedprob(self,f,cat,prf,weight=1.0,ap=0.5):
        ...
        # Count the number of times this feture has appeared in all categories
...
class fisherclassifier(classifier):
    ...
    def fisherprob(self,item,cat):
        ...
        # Use teh inverse chi2 function to get the probability
